...
from .flatland_treelstm import (
    FlatlandTreeGNNPolicy,
    FlatlandTreeGNNPolicyConfig,
    FlatlandTreeGNNCritic,
    FlatlandTreeGNNCriticConfig,
    FlatlandTreeLSTMFeature,
    FlatlandTreeLSTMFeatureConfig,
    FlatlandTreeTransformerFeature,
...
model_config_registry = {
    ...
    "gru": GruConfig,
    "lstm": LstmConfig,
    "flatland_treegnn": FlatlandTreeGNNPolicyConfig,
    "flatland_treegnn_critic": FlatlandTreeGNNCriticConfig,
    "flatland_treelstm_feature": FlatlandTreeLSTMFeatureConfig,
    "flatland_tree_transformer_feature": FlatlandTreeTransformerFeatureConfig,
